This is a web-based Tic Tac Toe game built using **HTML**, **CSS**, and **JavaScript**. It's a simple two-player game where players take turns to place their symbol (X or O) on a 3x3 grid.
